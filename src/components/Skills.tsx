...
import { Code, Database, Server, Terminal, Layout, PenTool as Tool, Cloud, GitBranch, BrainCircuit } from 'lucide-react';
    ...
    <section id="skills" className="py-20 bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <SkillCategory
            icon={<BrainCircuit />} // Need to import BrainCircuit
