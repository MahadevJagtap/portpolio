      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              I'm a passionate B.Tech student in Artificial Intelligence and Machine Learning.
              With a strong foundation in both frontend and backend development, I specialize in creating
              scalable, efficient, and user-friendly applications. My interest lies in the intersection
              of AI, Machine Learning, and Full Stack Development.
            </motion.p>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              I thrive on building innovative and efficient solutions, whether through full-stack development,
              AI integration, or optimizing user experiences. I believe in continuous learning and experimentation,
              always seeking new challenges to refine my skills and stay ahead in the ever-evolving tech landscape.
            </motion.p>
            ...
            >
              ...
              <Stat icon={<Server />} label="Hackathons" value="4" />
          ...
          <motion.div className="space-y-6" variants={containerVariants}>
            <ExperienceCard
              title="Dayananda Sagar University, Bengaluru"
              subtitle="Student"
              period="2022 – 2026"
              description="B.Tech in Artificial Intelligence and Machine Learning. CGPA: 7.62/10"
              isActive={true}
              showDetails={false}
            />

            <ExperienceCard
              title="Diamond Group of Institutions"
              subtitle="Pre-University (PCM)"
              period="2020 – 2022"
            ...
            <ExperienceCard
              title="S.N.S Gurukul School"
              subtitle="SSLC (10th Standard)"
              period="2018 – 2020"
