      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <a href="#" className="text-xl font-bold text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-white/90 transition-colors">MJ</a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <SocialLink href="https://github.com/MahadevJagtap" icon={<Github size={20} />} />
            <SocialLink href="https://www.linkedin.com/in/mahadev-jagtap-b3a651263/" icon={<Linkedin size={20} />} />
            <button
              onClick={() => {
                toggleTheme();
