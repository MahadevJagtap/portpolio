            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-gray-200/20 dark:border-white/5 shadow-sm">
              ...
              <div className="space-y-6">
                <ContactInfo
                  icon={<Mail />}
                  title="Email"
                  content="mmjagtap007@gmail.com"
                />
                <ContactInfo
                  icon={<Phone />}
                  title="Phone"
                  content="+91 9019758571"
                />
                <ContactInfo
                  icon={<MapPin />}
                  title="Location"
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-gray-200/20 dark:border-white/5 shadow-sm">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className={`w-full px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-black rounded-lg transition-colors flex items-center justify-center gap-2 ${status.loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-800 dark:hover:bg-gray-200'
                    }`}
