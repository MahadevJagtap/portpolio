      ...
      name: 'public', type: 'dir', children: [
        {
          name: 'resume', type: 'dir', children: [
            { name: 'Mahadev_Resume.pdf', type: 'file' },
          ]
        },
...
│                          MAHADEV                          │
│                                                             │
│  🎓 B.Tech AI & ML @ Dayananda Sagar University           │
...
───────────────────────────── RESUME ─────────────────────────────
Name: Mahadev
Role: B.Tech AI & ML Student | Full Stack Developer | AI Engineer
...
const Terminal = ({ onMatrixFullscreen }: TerminalProps) => {
  ...
  const getPrompt = () =>
    `mahadev@portfolio:${cwd.length ? '/' + cwd.join('/') : '~'}$`;
