  ...
  useEffect(() => {
    ...
    if (typedRef.current) {
      const typed = new Typed(typedRef.current, {
        strings: ['AI & ML Enthusiast', 'Full Stack Developer', 'Data Science Enthusiast'],
        typeSpeed: 50,
        backSpeed: 30,
        loop: true,
        backDelay: 1500,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900 dark:text-white">
            ...
            >
              Hi, I'm <span className="text-gray-900 dark:text-white">MAHADEV</span>
            </motion.span>
            <motion.span
              className="block text-gray-600 dark:text-white/70 mt-2 text-2xl md:text-3xl"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            ...
            >
              <SocialLink href="https://github.com/MahadevJagtap" icon={<Github size={24} />} />
              <SocialLink href="https://www.linkedin.com/in/mahadev-jagtap-b3a651263/" icon={<Linkedin size={24} />} />
